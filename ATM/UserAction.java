...
public class UserAction {
    ...
    public static void deposit(User user, Scanner scanner) { //method to deposit user amount
        ...
        if (amount == denominationamount) {// if equals
    ...
    public static void withdraw(User user, Scanner scanner) throws CloneNotSupportedException { //method to withdraw amount
        ...
        ArrayList<Notes> duplicateTransaction=new ArrayList<Notes>();//created new list to store duplicate transaction
            ...
            if(withdrawAmount<=Atm.getAtmbalance()){
                ...
                while (withdrawAmount!=0){
                    ...
                    if(withdrawAmount==0)
                    {
                        ...
                        user.getTransactions().add(new Transactions(user.getId(), "Withdrawn", storeamount));
